...
var ctx = canvas.getContext('2d'); // 使用2D繪圖ctx.fillRect(300,100,500,500); //畫了一個座標為(300,100)的500px * 500px的矩形
...
ctx.clearRect(600,150,100,100); //再清除一個座標為(500,300)的100px * 100px的矩形形狀
ctx.strokeRect(625,175,50,50); //最後畫一個座標為(42,175)的50px * 50px的矩形邊框
